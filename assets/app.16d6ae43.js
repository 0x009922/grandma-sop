...
function setVarsOnNode(el, vars2) {
  if (el.nodeType === 1) {
    ...
    for (const key in vars2) {
      style.setProperty(`--${key}`, vars2[key]);
    }
  }
}
...
var serializedSiteData = '{"lang":"en-US","title":"\u0421\u041E\u041F","description":"\u0421\u0442\u0430\u043D\u0434\u0430\u0440\u0442\u043D\u044B\u0435 \u043E\u043F\u0435\u0440\u0430\u0446\u0438\u043E\u043D\u043D\u044B\u0435 \u043F\u0440\u043E\u0446\u0435\u0434\u0443\u0440\u044B \u043F\u043E \u043F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u043D\u0438\u044E \u0442\u0435\u043B\u0435\u0444\u043E\u043D\u043E\u043C \u0438 \u043D\u0435 \u0442\u043E\u043B\u044C\u043A\u043E","base":"/sop/","head":[],"themeConfig":{"sidebar":{"/":[{"text":"\u0413\u043B\u0430\u0432\u043D\u0430\u044F","link":"/"},{"text":"Android - YouTube","children":[{"text":"\u041F\u043E\u0438\u0441\u043A \u0432\u0438\u0434\u0435\u043E","link":"/android/youtube/search"},{"text":"\u041F\u043E\u0438\u0441\u043A \u043A\u0430\u043D\u0430\u043B\u0430","link":"/android/youtube/search-channel"},{"text":"\u0423\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u0438\u0435 \u0432\u0438\u0434\u0435\u043E","link":"/android/youtube/video-controls"},{"text":"\u0417\u0430\u043A\u0440\u044B\u0442\u0438\u0435 \u0432\u0438\u0434\u0435\u043E","link":"/android/youtube/close-video"}]}]}},"locales":{},"langs":{}}';
...
function isSideBarGroup(item) {
  return item.children !== void 0;
}
function isSideBarEmpty(sidebar) {
...
const _hoisted_1$n = ["href", "aria-label"];
const _hoisted_2$g = ["src"];
const _sfc_main$q = /* @__PURE__ */ defineComponent({
  setup(__props) {
    const { site, theme: theme2, localePath } = useData();
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("a", {
        class: "nav-bar-title",
        href: unref(localePath),
        "aria-label": `${unref(site).title}, back to home`
      }, [
        unref(theme2).logo ? (openBlock(), createElementBlock("img", {
          key: 0,
          class: "logo",
          src: unref(withBase)(unref(theme2).logo),
          alt: "Logo"
...
var NavBarTitle = /* @__PURE__ */ _export_sfc(_sfc_main$q, [["__scopeId", "data-v-15622a9a"]]);
function useLanguageLinks() {
  const { site, localePath, theme: theme2 } = useData();
  return computed(() => {
    ...
    const candidates = localePaths.map((localePath2) => ({
      text: langs[localePath2].label,
      link: `${localePath2}${currentPath}`
    }));
    const selectText = theme2.value.selectText || "Languages";
    return {
      text: selectText,
      items: candidates
    };
...
function useRepo() {
  ...
  return computed(() => {
    ...
    const name = theme2.docsRepo || theme2.repo;
    if (!name) {
      return null;
    }
    const link2 = getRepoUrl(name);
    const text = getRepoText(link2, theme2.repoLabel);
...
function useNavLink(item) {
  const route = useRoute();
  const isExternal$1 = isExternal(item.value.link);
  const props = computed(() => {
    ...
    return {
      ...
      href: isExternal$1 ? item.value.link : withBase(item.value.link),
      target: item.value.target || (isExternal$1 ? `_blank` : null),
      rel: item.value.rel || (isExternal$1 ? `noopener noreferrer` : null),
...
var OutboundLink_vue_vue_type_style_index_0_lang = "";
const _sfc_main$p = {};
const _hoisted_1$m = {
  class: "icon outbound",
...
const _hoisted_3$b = /* @__PURE__ */ createBaseVNode("polygon", {
  fill: "currentColor",
...
var OutboundLink = /* @__PURE__ */ _export_sfc(_sfc_main$p, [["render", _sfc_render$6]]);
var NavLink_vue_vue_type_style_index_0_scoped_true_lang = "";
const _hoisted_1$l = { class: "nav-link" };
const _sfc_main$o = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const { props: linkProps, isExternal: isExternal2 } = useNavLink(propsRefs.item);
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$l, [
        createBaseVNode("a", mergeProps({ class: "item" }, unref(linkProps)), [
          createTextVNode(toDisplayString(__props.item.text) + " ", 1),
          unref(isExternal2) ? (openBlock(), createBlock(OutboundLink, { key: 0 })) : createCommentVNode("v-if", true)
        ], 16)
      ]);
    };
  }
});
var NavLink = /* @__PURE__ */ _export_sfc(_sfc_main$o, [["__scopeId", "data-v-69d3bbe8"]]);
var NavDropdownLinkItem_vue_vue_type_style_index_0_scoped_true_lang = "";
const _withScopeId$1 = (n) => (pushScopeId("data-v-3dac4be6"), n = n(), popScopeId(), n);
const _hoisted_1$k = { class: "nav-dropdown-link-item" };
const _hoisted_2$e = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createBaseVNode("span", { class: "arrow" }, null, -1));
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$k, [
        createBaseVNode("a", mergeProps({ class: "item" }, unref(linkProps)), [
          _hoisted_2$e,
          createBaseVNode("span", _hoisted_3$a, toDisplayString(__props.item.text), 1),
...
var NavDropdownLinkItem = /* @__PURE__ */ _export_sfc(_sfc_main$n, [["__scopeId", "data-v-3dac4be6"]]);
var NavDropdownLink_vue_vue_type_style_index_0_scoped_true_lang = "";
const _hoisted_1$j = ["aria-label"];
const _hoisted_2$d = { class: "button-text" };
const _hoisted_3$9 = { class: "dialog" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        class: normalizeClass(["nav-dropdown-link", { open: open.value }])
      }, [
        createBaseVNode("button", {
          ...
          createBaseVNode("span", _hoisted_2$d, toDisplayString(__props.item.text), 1),
          createBaseVNode("span", {
            class: normalizeClass(["button-arrow", open.value ? "down" : "right"])
          }, null, 2)
        ], 8, _hoisted_1$j),
        createBaseVNode("ul", _hoisted_3$9, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(__props.item.items, (item) => {
            return openBlock(), createElementBlock("li", {
              key: item.text,
              class: "dialog-item"
            }, [
              createVNode(NavDropdownLinkItem, { item }, null, 8, ["item"])
            ]);
          }), 128))
        ])
      ], 2);
...
var NavDropdownLink = /* @__PURE__ */ _export_sfc(_sfc_main$m, [["__scopeId", "data-v-01aa3326"]]);
var NavLinks_vue_vue_type_style_index_0_scoped_true_lang = "";
const _hoisted_1$i = {
  key: 0,
  class: "nav-links"
};
...
const _sfc_main$l = /* @__PURE__ */ defineComponent({
  setup(__props) {
    ...
    const repo = useRepo();
    const show = computed(() => theme2.value.nav || repo.value || localeLinks.value);
    return (_ctx, _cache) => {
      return unref(show) ? (openBlock(), createElementBlock("nav", _hoisted_1$i, [
        unref(theme2).nav ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(unref(theme2).nav, (item) => {
          return openBlock(), createElementBlock("div", {
            key: item.text,
            class: "item"
          }, [
            item.items ? (openBlock(), createBlock(NavDropdownLink, {
              key: 0,
              item
            }, null, 8, ["item"])) : (openBlock(), createBlock(NavLink, {
              key: 1,
              item
            }, null, 8, ["item"]))
          ]);
        }), 128)) : createCommentVNode("v-if", true),
        unref(localeLinks) ? (openBlock(), createElementBlock("div", _hoisted_2$c, [
          createVNode(NavDropdownLink, { item: unref(localeLinks) }, null, 8, ["item"])
        ])) : createCommentVNode("v-if", true),
        unref(repo) ? (openBlock(), createElementBlock("div", _hoisted_3$8, [
          createVNode(NavLink, { item: unref(repo) }, null, 8, ["item"])
        ])) : createCommentVNode("v-if", true)
      ])) : createCommentVNode("v-if", true);
    };
  }
});
var NavLinks = /* @__PURE__ */ _export_sfc(_sfc_main$l, [["__scopeId", "data-v-6f0c9d13"]]);
var ToggleSideBarButton_vue_vue_type_style_index_0_lang = "";
const _sfc_main$k = {
  emits: ["toggle"]
};
...
var ToggleSideBarButton = /* @__PURE__ */ _export_sfc(_sfc_main$k, [["render", _sfc_render$5]]);
var NavBar_vue_vue_type_style_index_0_scoped_true_lang = "";
const _withScopeId = (n) => (pushScopeId("data-v-9c8ff0fa"), n = n(), popScopeId(), n);
const _hoisted_1$g = { class: "nav-bar" };
const _hoisted_2$a = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("div", { class: "flex-grow" }, null, -1));
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("header", _hoisted_1$g, [
        ...
        createVNode(NavBarTitle),
        _hoisted_2$a,
        createBaseVNode("div", _hoisted_3$7, [
          createVNode(NavLinks)
        ]),
...
var NavBar = /* @__PURE__ */ _export_sfc(_sfc_main$j, [["__scopeId", "data-v-9c8ff0fa"]]);
function useActiveSidebarLinks() {
  let rootActiveLink = null;
  let activeLink = null;
  const onScroll = throttleAndDebounce(setActiveLink, 300);
  function setActiveLink() {
    const sidebarLinks2 = getSidebarLinks();
    const anchors = getAnchors(sidebarLinks2);
  ...
  function deactiveLink(link2) {
    link2 && link2.classList.remove("active");
  }
  onMounted(() => {
    setActiveLink();
...
function getAnchors(sidebarLinks2) {
  return [].slice.call(document.querySelectorAll(".header-anchor")).filter((anchor) => sidebarLinks2.some((sidebarLink) => sidebarLink.hash === anchor.hash));
}
...
const SideBarLink = (props) => {
  ...
  const link2 = resolveLink(site.value.base, props.item.link);
...
function createChildren(active, children, headers, depth = 1) {
  ...
  return active && headers ? createChildren(false, resolveHeaders(headers), void 0, depth) : null;
}
...
const _sfc_main$i = /* @__PURE__ */ defineComponent({
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return unref(items).length > 0 ? (openBlock(), createElementBlock("ul", _hoisted_1$f, [
        (openBlock(true), createElementBlock(Fragment, null, renderList(unref(items), (item) => {
          return openBlock(), createBlock(unref(SideBarLink), { item }, null, 8, ["item"]);
        }), 256))
      ])) : createCommentVNode("v-if", true);
    };
  }
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("aside", {
        class: normalizeClass(["sidebar", { open: __props.open }])
      }, [
        createVNode(NavLinks, { class: "nav" }),
...
var SideBar = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["__scopeId", "data-v-381d617a"]]);
const bitbucketRE = /bitbucket.org/;
function useEditLink() {
  const { page, theme: theme2, frontmatter } = useData();
  const url = computed(() => {
    const { repo, docsDir = "", docsBranch = "master", docsRepo = repo, editLinks } = theme2.value;
  ...
  const text = computed(() => {
    return theme2.value.editLinkText || "Edit this page";
  });
  return {
    url,
    text
...
function createUrl(repo, docsRepo, docsDir, docsBranch, path) {
  return bitbucketRE.test(repo) ? createBitbucketUrl(repo, docsRepo, docsDir, docsBranch, path) : createGitHubUrl(repo, docsRepo, docsDir, docsBranch, path);
}
...
function createBitbucketUrl(repo, docsRepo, docsDir, docsBranch, path) {
  ...
  return base.replace(endingSlashRE, "") + `/src/${docsBranch}/` + (docsDir ? docsDir.replace(endingSlashRE, "") + "/" : "") + path + `?mode=edit&spa=0&at=${docsBranch}&fileviewer=file-view-default`;
}
var EditLink_vue_vue_type_style_index_0_scoped_true_lang = "";
const _hoisted_1$e = { class: "edit-link" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$e, [
        unref(url) ? (openBlock(), createElementBlock("a", {
          key: 0,
          class: "link",
          href: unref(url),
          target: "_blank",
          ...
          createVNode(OutboundLink, { class: "icon" })
        ], 8, _hoisted_2$9)) : createCommentVNode("v-if", true)
      ]);
    };
  }
});
var EditLink = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["__scopeId", "data-v-f83947fa"]]);
var LastUpdated_vue_vue_type_style_index_0_scoped_true_lang = "";
const _hoisted_1$d = {
  key: 0,
  class: "last-updated"
};
const _hoisted_2$8 = { class: "prefix" };
const _hoisted_3$6 = { class: "datetime" };
const _sfc_main$f = /* @__PURE__ */ defineComponent({
  setup(__props) {
    const { theme: theme2, page } = useData();
    const hasLastUpdated = computed(() => {
      const lu = theme2.value.lastUpdated;
      return lu !== void 0 && lu !== false;
    });
    const prefix = computed(() => {
      const p2 = theme2.value.lastUpdated;
      return p2 === true ? "Last Updated" : p2;
    });
    const datetime = ref("");
    onMounted(() => {
    ...
    return (_ctx, _cache) => {
      return unref(hasLastUpdated) ? (openBlock(), createElementBlock("p", _hoisted_1$d, [
        createBaseVNode("span", _hoisted_2$8, toDisplayString(unref(prefix)) + ":", 1),
        createBaseVNode("span", _hoisted_3$6, toDisplayString(datetime.value), 1)
      ])) : createCommentVNode("v-if", true);
    };
  }
});
var LastUpdated = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["__scopeId", "data-v-3de14349"]]);
var PageFooter_vue_vue_type_style_index_0_scoped_true_lang = "";
const _hoisted_1$c = { class: "page-footer" };
const _hoisted_2$7 = { class: "edit" };
const _hoisted_3$5 = { class: "updated" };
const _sfc_main$e = /* @__PURE__ */ defineComponent({
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("footer", _hoisted_1$c, [
        createBaseVNode("div", _hoisted_2$7, [
          createVNode(EditLink)
        ]),
        createBaseVNode("div", _hoisted_3$5, [
          createVNode(LastUpdated)
        ])
      ]);
    };
  }
});
var PageFooter = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["__scopeId", "data-v-f9d8296a"]]);
function useNextAndPrevLinks() {
  const { page, theme: theme2 } = useData();
  const path = computed(() => {
    return removeExtention(ensureStartingSlash(page.value.relativePath));
  });
  const candidates = computed(() => {
    const config = getSideBarConfig(theme2.value.sidebar, path.value);
  ...
  const next = computed(() => {
    if (theme2.value.nextLinks !== false && index.value > -1 && index.value < candidates.value.length - 1) {
      return candidates.value[index.value + 1];
    }
  });
  const prev = computed(() => {
    if (theme2.value.prevLinks !== false && index.value > 0) {
      return candidates.value[index.value - 1];
    }
  });
...
const _hoisted_2$6 = /* @__PURE__ */ createBaseVNode("path", { d: "M19,11H7.4l5.3-5.3c0.4-0.4,0.4-1,0-1.4s-1-0.4-1.4,0l-7,7c-0.1,0.1-0.2,0.2-0.2,0.3c-0.1,0.2-0.1,0.5,0,0.8c0.1,0.1,0.1,0.2,0.2,0.3l7,7c0.2,0.2,0.5,0.3,0.7,0.3s0.5-0.1,0.7-0.3c0.4-0.4,0.4-1,0-1.4L7.4,13H19c0.6,0,1-0.4,1-1S19.6,11,19,11z" }, null, -1);
const _hoisted_3$4 = [
  _hoisted_2$6
];
...
var ArrowLeft = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["render", _sfc_render$4]]);
const _sfc_main$c = {};
const _hoisted_1$a = {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24"
...
var ArrowRight = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["render", _sfc_render$3]]);
var NextAndPrevLinks_vue_vue_type_style_index_0_scoped_true_lang = "";
const _hoisted_1$9 = {
  key: 0,
  class: "next-and-prev-link"
};
const _hoisted_2$4 = { class: "container" };
const _hoisted_3$2 = { class: "prev" };
const _hoisted_4$1 = ["href"];
const _hoisted_5 = { class: "text" };
const _hoisted_6 = { class: "next" };
...
const _sfc_main$b = /* @__PURE__ */ defineComponent({
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return unref(hasLinks) ? (openBlock(), createElementBlock("div", _hoisted_1$9, [
        createBaseVNode("div", _hoisted_2$4, [
          createBaseVNode("div", _hoisted_3$2, [
            unref(prev) ? (openBlock(), createElementBlock("a", {
              key: 0,
              class: "link",
              href: unref(withBase)(unref(prev).link)
            }, [
              createVNode(ArrowLeft, { class: "icon icon-prev" }),
              createBaseVNode("span", _hoisted_5, toDisplayString(unref(prev).text), 1)
            ], 8, _hoisted_4$1)) : createCommentVNode("v-if", true)
          ]),
          createBaseVNode("div", _hoisted_6, [
            unref(next) ? (openBlock(), createElementBlock("a", {
              key: 0,
              class: "link",
              href: unref(withBase)(unref(next).link)
            }, [
              createBaseVNode("span", _hoisted_8, toDisplayString(unref(next).text), 1),
              createVNode(ArrowRight, { class: "icon icon-next" })
...
var NextAndPrevLinks = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["__scopeId", "data-v-53899271"]]);
...
const _sfc_main$a = /* @__PURE__ */ defineComponent({
  setup(__props) {
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("main", _hoisted_1$8, [
        createBaseVNode("div", _hoisted_2$3, [
          renderSlot(_ctx.$slots, "top", {}, void 0, true),
          createVNode(_component_Content, { class: "content" }),
          createVNode(PageFooter),
          createVNode(NextAndPrevLinks),
...
var Page = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["__scopeId", "data-v-3ff2a2f2"]]);
...
const _sfc_main$9 = /* @__PURE__ */ defineComponent({
  setup(__props) {
    const Home = defineAsyncComponent(() => import("./Home.0d27f7a2.js"));
    const NoopComponent = () => null;
    const CarbonAds = NoopComponent;
    const BuySellAds = NoopComponent;
    const AlgoliaSearchBox = NoopComponent;
    const route = useRoute();
    const { site, page, theme: theme2, frontmatter } = useData();
    ...
    const showNavbar = computed(() => {
      const themeConfig = theme2.value;
    ...
    const showSidebar = computed(() => {
      ...
      return !isSideBarEmpty(getSideBarConfig(theme2.value.sidebar, route.data.relativePath));
    });
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        createBaseVNode("div", {
          class: normalizeClass(["theme", unref(pageClasses)])
        }, [
          unref(showNavbar) ? (openBlock(), createBlock(NavBar, {
            key: 0,
            onToggle: toggleSidebar
          }, {
            search: withCtx(() => [
              renderSlot(_ctx.$slots, "navbar-search", {}, () => [
                unref(theme2).algolia ? (openBlock(), createBlock(unref(AlgoliaSearchBox), {
                  key: 0,
                  options: unref(theme2).algolia,
                  multilang: unref(isMultiLang)
                }, null, 8, ["options", "multilang"])) : createCommentVNode("v-if", true)
              ])
            ]),
            _: 3
          })) : createCommentVNode("v-if", true),
          createVNode(SideBar, { open: openSideBar.value }, {
            "sidebar-top": withCtx(() => [
          ...
          createCommentVNode(" TODO: make this button accessible "),
          createBaseVNode("div", {
            class: "sidebar-mask",
            onClick: _cache[0] || (_cache[0] = ($event) => toggleSidebar(false))
          }),
          unref(isCustomLayout) ? (openBlock(), createBlock(_component_Content, { key: 1 })) : unref(enableHome) ? (openBlock(), createElementBlock(Fragment, { key: 2 }, [
            createCommentVNode(" A slot for customizing the entire homepage easily "),
            renderSlot(_ctx.$slots, "home", {}, () => [
              createVNode(unref(Home), null, {
                hero: withCtx(() => [
                  renderSlot(_ctx.$slots, "home-hero")
                ]),
                features: withCtx(() => [
                  renderSlot(_ctx.$slots, "home-features")
                ]),
                footer: withCtx(() => [
                  renderSlot(_ctx.$slots, "home-footer")
                ]),
                _: 3
              })
            ])
          ], 2112)) : (openBlock(), createBlock(Page, { key: 3 }, {
            top: withCtx(() => [
              renderSlot(_ctx.$slots, "page-top-ads", {}, () => [
                unref(theme2).carbonAds && unref(theme2).carbonAds.carbon ? (openBlock(), createElementBlock("div", _hoisted_1$7, [
                  createVNode(unref(CarbonAds), {
                    key: "carbon" + unref(page).relativePath,
                    code: unref(theme2).carbonAds.carbon,
                    placement: unref(theme2).carbonAds.placement
                  }, null, 8, ["code", "placement"])
                ])) : createCommentVNode("v-if", true)
              ]),
            ...
            bottom: withCtx(() => [
              ...
              renderSlot(_ctx.$slots, "page-bottom-ads", {}, () => [
                unref(theme2).carbonAds && unref(theme2).carbonAds.custom ? (openBlock(), createBlock(unref(BuySellAds), {
                  key: "custom" + unref(page).relativePath,
                  code: unref(theme2).carbonAds.custom,
                  placement: unref(theme2).carbonAds.placement
                }, null, 8, ["code", "placement"])) : createCommentVNode("v-if", true)
              ])
            ]),
            _: 3
          }))
...
const _hoisted_1$6 = { class: "theme" };
const _hoisted_2$2 = /* @__PURE__ */ createBaseVNode("h1", null, "404", -1);
...
var Layout = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-12fb9e74"]]);
function and(...args) {
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    whenever(() => props.flag, () => triggered.value = true, { immediate: true });
    return (_ctx, _cache) => {
      return renderSlot(_ctx.$slots, "default", normalizeProps(guardReactiveProps({ triggered: triggered.value })));
    };
  }
});
const KEY = Symbol("Demo");
function useDemoShared() {
  const x = inject(KEY);
  if (!x)
    throw new Error("injection failed");
  return x;
}
var DemoMediaVideo_vue_vue_type_style_index_0_lang = "";
const _hoisted_1$5 = { class: "demo-media-video" };
const _hoisted_2$1 = ["width", "height"];
const _hoisted_3 = ["src"];
const _hoisted_4 = /* @__PURE__ */ createBaseVNode("div", { class: "demo-media-video__slider" }, null, -1);
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  setup(__props) {
    useCssVars((_ctx) => ({
      "70ebfad9": unref(sliderRight)
    }));
    const shared = useDemoShared();
    const isActive2 = computed(() => shared.active);
    ...
    function updateTime() {
      const el2 = getVideoElSoft();
      if (el2) {
        currentTime.value = el2.currentTime;
      }
    }
    ...
    whenever(and(isActive2, isElemMounted, not(actuallyPlaying)), () => (play(), resumeTimeUpdate()), { immediate: true });
    whenever(and(not(isActive2), isElemMounted, actuallyPlaying), () => (pause(), resetTime(), pauseTimeUpdate()), {
      immediate: true
    });
    return (_ctx, _cache) => {
      return withDirectives((openBlock(), createElementBlock("div", _hoisted_1$5, [
        createBaseVNode("video", {
          ...
          width: unref(shared).width,
          height: unref(shared).height,
          loop: "",
          autoplay: "",
          muted: "",
          onCanplay: _cache[0] || (_cache[0] = ($event) => canPlay.value = true),
          onPlay: _cache[1] || (_cache[1] = ($event) => actuallyPlaying.value = true),
          onPause: _cache[2] || (_cache[2] = ($event) => actuallyPlaying.value = false),
          onTimeupdate: updateTime,
          onLoadeddata: loaded,
          onClick: resetTime
        }, [
          createBaseVNode("source", {
            src: unref(shared).src
          }, null, 8, _hoisted_3)
        ], 40, _hoisted_2$1),
        _hoisted_4
      ], 512)), [
        [vShow, unref(shared).visible]
      ]);
    };
  }
});
const _hoisted_1$4 = ["src", "height", "width"];
...
const _hoisted_1$3 = { class: "img-demo" };
const _hoisted_2 = {
  key: 0,
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const props = __props;
    useCssVars((_ctx) => ({
      "7ae57f74": unref(widthPx),
      "005d256e": unref(heightPx)
    }));
    ...
    useIntersectionObserver(imgContainer, ([{ isIntersecting }]) => {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$3, [
        createBaseVNode("div", {
          ref: (_value, _refs) => {
            _refs["imgContainer"] = _value;
            isRef(imgContainer) && (imgContainer.value = _value);
          },
          class: "img-demo__img-container"
        }, [
          createVNode(_sfc_main$6, { flag: isImgVisible.value }, {
            default: withCtx(({ triggered }) => [
              createVNode(Transition, { name: "img-fade-transition" }, {
                default: withCtx(() => [
                  triggered ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                    unref(isVideo) ? (openBlock(), createBlock(_sfc_main$5, { key: 0 })) : (openBlock(), createBlock(_sfc_main$4, { key: 1 }))
        ...
        __props.description || unref(isDescriptionSlotDefined) ? (openBlock(), createElementBlock("div", _hoisted_2, [
...
var InlineIcon_vue_vue_type_style_index_0_lang = "";
const _sfc_main$2 = {};
const _hoisted_1$2 = { class: "inline-icon" };
function _sfc_render$2(_ctx, _cache) {
  return openBlock(), createElementBlock("span", _hoisted_1$2, [
    renderSlot(_ctx.$slots, "default")
  ]);
}
var InlineIcon = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$2]]);
const _sfc_main$1 = {};
const _hoisted_1$1 = { class: "flex justify-center" };
function _sfc_render$1(_ctx, _cache) {
  return openBlock(), createElementBlock("div", _hoisted_1$1, [
    renderSlot(_ctx.$slots, "default")
  ]);
}
var HorCenter = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render$1]]);
...
var Tag = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-2987adcc"]]);
var Theme = __spreadProps(__spreadValues({}, theme), {
  Layout,
  enhanceApp({ app }) {
    app.component("Demo", _sfc_main$3);
...
export { Fragment as F, NavLink as N, _export_sfc as _, createBaseVNode as a, createVNode as b, createElementBlock as c, createApp, createCommentVNode as d, createTextVNode as e, createStaticVNode as f, defineComponent as g, useData as h, computed as i, withBase as j, createBlock as k, renderList as l, renderSlot as m, openBlock as o, resolveComponent as r, toDisplayString as t, unref as u, withCtx as w };
